...
For everyday use, start with the installed skills in the [README](../README.md).
The workflow below is optional for API automation, CI and strict local approval records.
...
English agent instructions and reports; [Serbian getting-started guide](POCNI_OVDE.md).
...
passing mode. See [the Windows example](POCNI_OVDE.md).
...
- [Start here, in Serbian](POCNI_OVDE.md)
- [Architecture, article alignment and design tradeoffs](ARCHITECTURE.md)
- [Team workflow and review ownership](OPERATING_MODEL.md)
- [Personal use and coding assistant handoff](ASSISTANT_WORKFLOW.md)
- [Pilot/evaluation and bottleneck measurements](PILOT.md)
- [CI integration](CI.md)
- [Security and practical limits](../SECURITY.md)
- [Build verification record](VALIDATION.md)
...
## Publishing another local copy

The source is published at `milosmilicevicsf/quality-agents`. The legacy publishing script expects a private destination; it is not needed to use the toolkit.
